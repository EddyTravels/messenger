...
const (
	...
	ProfileURL = "https://graph.facebook.com/v8.0/"
	// SendSettingsURL is API endpoint for saving settings.
	SendSettingsURL = "https://graph.facebook.com/v8.0/me/thread_settings"
	...
	MessengerProfileURL = "https://graph.facebook.com/v8.0/me/messenger_profile"
)
